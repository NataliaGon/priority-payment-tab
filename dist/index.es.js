...
var OptionItem = /** @class */ (function (_super) {
    ...
    OptionItem.prototype.render = function () {
        ...
        return (createElement("li", { className: elementClasses, onClick: this.props.onClick },
            createElement(Icon, { icon: PriorityIcon.operatorSearchBetween, iconColor: this.props.isClicked ? "blue" : "grey" }),
            createElement(Label, { textColor: this.props.isClicked ? "blue" : "grey", skin: "regular" }, this.props.children),
...
var Select = /** @class */ (function (_super) {
    ...
    function Select() {
        ...
        _this.renderOptions = function () {
            ...
            if (_this.props.options && Array.isArray(_this.props.options)) {
                return (createElement("ul", { className: styles$7.ul },
                    createElement(OptionItem, { iconName: firstElem.iconName, isClicked: _this.state.isOpen }, firstElem.name),
                    restElems.map(function (option) { return (createElement(OptionItem, { iconName: option.iconName }, option.name)); })));
            }
            else {
                return null;
            }
    ...
    Select.prototype.render = function () {
        ...
        return (createElement("div", { className: dropDownElementsStyles },
            createElement("div", { className: smallInputOptionsClasses, onClick: this.dropDownToggle },
                createElement("div", { className: styles$7.dropDownIconWrapper },
                    createElement(Icon, { iconColor: this.state.isOpen ? "blue" : "grey", icon: classForDropDownIcon }))),
    ...
    AutoFill.prototype.render = function () {
        ...
        return (createElement("div", { className: styles$9.component },
            createElement(Autocomplete, { items: [
                    ...
                    return createElement("div", { key: item.id, style: { backgroundColor: highlighted ? '#D9F6F9' : 'transparent' } }, item.label);
...
var StackPanel = /** @class */ (function (_super) {
    ...
    StackPanel.prototype.render = function () {
        ...
        var componentClasses = classnames(styles$b.component, skinClass);
...
var WrapPanel = /** @class */ (function (_super) {
    ...
    WrapPanel.prototype.render = function () {
        var skinClass = "";
        if (this.props.skin) {
            skinClass = styles$c[this.props.skin];
        }
        var componentClasses = classnames(styles$c.component, this.props.componentClasses, skinClass);
        return (createElement("div", { className: componentClasses }, this.props.children));
    };
    return WrapPanel;
}(ComponentBase));
...
var css$e = "/*** Colors ***/\n/*** End - Colors ***/\n/*** Font Families ***/\n/*** End - Font Families ***/\n/*** Font Size ***/\n/*** End - Font Size ***/\n/*** Font Weight ***/\n/*** End - Font Weight ***/\n.RowPanel-module_component__3wDnh {\n  width: 100%;\n  line-height: 100%;\n  display: flex;\n  flex-flow: row nowrap;\n  align-items: center;\n  justify-content: space-between; }\n\n.RowPanel-module_flex-start__1CNI6 {\n  justify-content: flex-start; }\n\n.RowPanel-module_flex-end__2qD_v {\n  justify-content: flex-end; }\n\n.RowPanel-module_center__10UYk {\n  justify-content: center; }\n\n.RowPanel-module_space-between__39IWO {\n  justify-content: space-between; }\n\n.RowPanel-module_topPadding__OuthB {\n  padding-top: 10px; }\n\n.RowPanel-module_bottomPadding__2lpOC {\n  padding-bottom: 10px; }\n";
var styles$d = {"component":"RowPanel-module_component__3wDnh","flex-start":"RowPanel-module_flex-start__1CNI6","flex-end":"RowPanel-module_flex-end__2qD_v","center":"RowPanel-module_center__10UYk","space-between":"RowPanel-module_space-between__39IWO","topPadding":"RowPanel-module_topPadding__OuthB","bottomPadding":"RowPanel-module_bottomPadding__2lpOC"};
styleInject(css$e);
...
var RowPanel = /** @class */ (function (_super) {
    ...
    RowPanel.prototype.render = function () {
        ...
        if (this.props.alignItems) {
            alignItemsClass = styles$d[this.props.alignItems];
        }
        if (this.props.paddingTop) {
            paddingTopClass = styles$d.topPadding;
        }
        if (this.props.paddingBottom) {
            paddingBottomClass = styles$d.bottomPadding;
        }
        var componentClasses = classnames(styles$d.component, this.props.componentClasses, alignItemsClass, paddingTopClass, paddingBottomClass);
        return (createElement("div", { className: componentClasses }, this.props.children));
    };
    return RowPanel;
}(ComponentBase));
...
var styles$e = {"component":"ScrollPanel-module_component__13H2d","gradient":"ScrollPanel-module_gradient__OvlCl","scrollArea":"ScrollPanel-module_scrollArea__3JylI","thumbVertical":"ScrollPanel-module_thumbVertical__2WPKQ"};
styleInject(css$f);
...
var styles$f = createCommonjsModule(function (module, exports) {
...
unwrapExports(styles$f);
var styles_1 = styles$f.containerStyleDefault;
var styles_2 = styles$f.containerStyleAutoHeight;
var styles_3 = styles$f.viewStyleDefault;
var styles_4 = styles$f.viewStyleAutoHeight;
var styles_5 = styles$f.viewStyleUniversalInitial;
var styles_6 = styles$f.trackHorizontalStyleDefault;
var styles_7 = styles$f.trackVerticalStyleDefault;
var styles_8 = styles$f.thumbHorizontalStyleDefault;
var styles_9 = styles$f.thumbVerticalStyleDefault;
var styles_10 = styles$f.disableSelectStyle;
var styles_11 = styles$f.disableSelectStyleReset;
...
var Scrollbars = function (_Component) {
    ...
    _createClass(Scrollbars, [{
        ...
        value: function setupDragging() {
            (0, _domCss2["default"])(document.body, styles$f.disableSelectStyle);
        ...
        value: function teardownDragging() {
            (0, _domCss2["default"])(document.body, styles$f.disableSelectStyleReset);
        ...
        value: function render() {
            ...
            var containerStyle = _extends({}, styles$f.containerStyleDefault, autoHeight && _extends({}, styles$f.containerStyleAutoHeight, {
                minHeight: autoHeightMin,
                maxHeight: autoHeightMax
            }), style);

            var viewStyle = _extends({}, styles$f.viewStyleDefault, {
                // Hide scrollbars by setting a negative margin
                marginRight: scrollbarWidth ? -scrollbarWidth : 0,
                marginBottom: scrollbarWidth ? -scrollbarWidth : 0
            }, autoHeight && _extends({}, styles$f.viewStyleAutoHeight, {
                ...
                minHeight: autoHeightMin,
                maxHeight: autoHeightMax
            }, universal && !didMountUniversal && styles$f.viewStyleUniversalInitial);
            ...
            var trackHorizontalStyle = _extends({}, styles$f.trackHorizontalStyleDefault, autoHide && trackAutoHeightStyle, (!scrollbarWidth || universal && !didMountUniversal) && {
                display: 'none'
            });

            var trackVerticalStyle = _extends({}, styles$f.trackVerticalStyleDefault, autoHide && trackAutoHeightStyle, (!scrollbarWidth || universal && !didMountUniversal) && {
                display: 'none'
            });
            ...
            return (0, React__default.createElement)(tagName, _extends({}, props, { style: containerStyle, ref: function ref(_ref3) {
                ...
                } }, (0, React__default.cloneElement)(renderThumbHorizontal({ style: styles$f.thumbHorizontalStyleDefault }), { ref: function ref(_ref6) {
                ...
                } }, (0, React__default.cloneElement)(renderThumbVertical({ style: styles$f.thumbVerticalStyleDefault }), { ref: function ref(_ref8) {
...
var Container = /** @class */ (function (_super) {
    ...
    Container.prototype.render = function () {
        ...
        var widthItemsClass = "";
        if (this.props.alignItems) {
            alignItemsClass = styles$h[this.props.alignItems];
        }
        if (this.props.ContainerWidth) {
            widthItemsClass = styles$h[this.props.ContainerWidth];
        }
        var icon = "";
        var iconReord = "";
        ...
        if (this.props.draggable) {
            iconReord =
                createElement("div", { className: styles$h.draggable },
...
var SidePanel = /** @class */ (function (_super) {
    ...
    SidePanel.prototype.render = function () {
        ...
        var classes = classnames(styles$i.component, this.props.componentClasses);
        return (createElement(reactTransitionGroup_4, { in: open, key: 'SidePanel', classNames: {
                enter: styles$i.enter,
                enterActive: styles$i.enterActive,
                exit: styles$i.leave,
                exitActive: styles$i.leaveActive
            }, timeout: 500, unmountOnExit: true }, function () { return (createElement("div", { className: styles$i.blocker },
...
var styles$j = {"component":"Tag-module_component__2Ut0y"};
styleInject(css$i);
...
var Tag = /** @class */ (function (_super) {
    ...
    Tag.prototype.render = function () {
        var elementClasses = classnames(styles$j.component, this.props.componentClasses);
...
var FormProperties = /** @class */ (function (_super) {
    __extends(FormProperties, _super);
...
var Form = /** @class */ (function (_super) {
    ...
    Form.prototype.render = function () {
        return (createElement(StackPanel, null,
            createElement(Container, { ContainerWidth: "fullWidth" },
                createElement(RowPanel, { paddingBottom: true },
                    createElement(Label, null, "Due Date")),
                createElement(RowPanel, null,
                    createElement(Select, { options: optionDropDown, width: "medium" }),
                    createElement("div", { className: styles$k.spaceHolder },
                        createElement(Label, null, "From")),
                    createElement(Select, { options: optionDropDown, width: "small" }),
                    createElement("div", { className: styles$k.spaceHolder },
