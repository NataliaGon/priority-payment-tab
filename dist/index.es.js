    ...
    AutoFill.prototype.render = function () {
        ...
        return (createElement("div", { className: styles$9.component },
            createElement(Autocomplete, { className: styles$9.inputComponent, items: [
                    ...
                    return createElement("div", { key: item.id, style: { backgroundColor: highlighted ? '#D9F6F9' : 'transparent' } },
                        createElement("input", { className: styles$9.inputCheckbox, type: "checkbox", name: "vehicle1", value: item.label }),
                        " ",
                        item.label,
