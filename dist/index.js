...
var AutoFill = /** @class */ (function (_super) {
    ...
    AutoFill.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles$9.component },
            React.createElement(Autocomplete, { getItemValue: function (item) { return item.label; }, items: [
                    { label: 'apple' },
                    { label: 'banana' },
                    { label: 'pear' }
                ], renderItem: function (item, isHighlighted) {
                    return React.createElement("div", { style: { background: isHighlighted ? 'lightgray' : 'white' } }, item.label);
