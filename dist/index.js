...
var AutoFill = /** @class */ (function (_super) {
    ...
    AutoFill.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles$9.component },
            React.createElement(Autocomplete, { className: styles$9.inputComponent, items: [
                    { id: 'foo', label: 'foo' },
                    { id: 'bar', label: 'bar' },
                    { id: 'baz', label: 'baz' },
                    { id: 'fo', label: 'fo' },
...
var GeneralInput = /** @class */ (function (_super) {
    ...
    GeneralInput.prototype.render = function () {
        var iconName = this.props.iconName ? exports.PriorityIcon[this.props.iconName] : "calendar";
        ...
        var iconOptinal = this.props.isIcon ? React.createElement("div", { className: styles$a.iconOptinal },
            React.createElement(Icon, { icon: iconName, iconColor: "grey" })) : '';
        ...
        return (React.createElement("div", { className: styles$a.component, onMouseEnter: this.HandlerEnter, onMouseLeave: this.HandlerMouseLeave },
            React.createElement("input", { className: classNamesInput, type: "text", onBlur: this.HandleOnBlur, onFocus: this.HandlerFocus, defaultValue: defaultVal }),
...
var ScrollPanel = /** @class */ (function (_super) {
    ...
    ScrollPanel.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles$e.component },
            ...
            gradient && !this.state.scrolledToEnd && React.createElement("div", { className: styles$e.gradient })));
    };
    return ScrollPanel;
}(ComponentBase));
...
var Container = /** @class */ (function (_super) {
    ...
    Container.prototype.render = function () {
        ...
        var inlineStyle = {};
        return (React.createElement("div", { className: componentClasses, style: inlineStyle, onMouseEnter: this.HandlerEnter, onMouseLeave: this.HandlerMouseLeave },
            icon,
            iconReord,
            this.props.children));
    };
...
var SidePanel = /** @class */ (function (_super) {
    ...
    SidePanel.prototype.render = function () {
        ...
        return (React.createElement(reactTransitionGroup_4, { in: open, key: 'SidePanel', classNames: {
            ...
            }, timeout: 500, unmountOnExit: true }, function () { return (React.createElement("div", { className: styles$i.blocker },
        ...
        return (React.createElement(StackPanel, null,
            React.createElement(Container, { ContainerWidth: "fullWidth" },
                ...
                React.createElement(RowPanel, { paddingBottom: true, paddingTop: true },
                    ...
                    React.createElement("div", { className: styles$k.spaceHolder }),
                    React.createElement(GeneralInput, { inputWidth: "small", isIcon: true, iconName: "calendar", defaultVal: "03/02/19" }),
                    React.createElement("div", { className: styles$k.spaceHolder }),
                    React.createElement(GeneralInput, { inputWidth: "small", isIcon: true, iconName: "calendar", defaultVal: "03/02/19" })),
...
var FooterSidePanel = /** @class */ (function (_super) {
    ...
    FooterSidePanel.prototype.render = function () {
        return (React.createElement("div", { className: styles$l.component },
            React.createElement(StackPanel, { skin: "dark" },
                React.createElement(RowPanel, { alignItems: "space-between" },
                    React.createElement(Container, null,
                        React.createElement(Icon, { icon: exports.PriorityIcon.clear, iconColor: "white" }),
                        React.createElement(Label, { skin: "regular-high-contrast", textColor: "white" }, "Clear Search")),
                    React.createElement(Container, { ContainerWidth: "250px", alignItems: "spaceBetween" },
                        React.createElement(WrapPanel, null,
                            React.createElement(Button, { skin: "stroke", width: "regularFixed" }, "Save as new"),
                            React.createElement(Button, { skin: "secondary", width: "regularFixed" }, "Save & Apply"),
                            React.createElement(Button, { skin: "regular", width: "regularFixed" }, "Apply")))))));
    };
...
exports.Tag = Tag;
exports.Form = Form;
exports.FooterSidePanel = FooterSidePanel;
//# sourceMappingURL=index.js.map
